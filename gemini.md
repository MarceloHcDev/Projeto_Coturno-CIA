...
│   ├── Usuarios_Gestao.jsx   # Página de Gerenciamento e Cadastro de Usuários
│   └── LogEventos.jsx       # Página de Monitoramento e Auditoria de Ações do Sistema (Logs de Eventos)
